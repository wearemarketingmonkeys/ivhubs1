  ...
  return (
    <div className="sitemap-page py-5" style={{ margin: "50px auto" }}>
      <div className="container">
        ...
        <li><a href="https://www.ivhub.com/iv-therapy/drips/detox-drip" target="_blank">Detox Drip</a></li>
        <li><a href="https://www.ivhub.com/iv-therapy/drips/hydration-hub-express" target="_blank">Hydration Hub Express</a></li>
        <li><a href="https://www.ivhub.com/iv-therapy/drips/nad-plus-100mg" target="_blank">NAD+ 100mg</a></li>
        <li><a href="https://www.ivhub.com/iv-therapy/drips/nad-plus-250mg" target="_blank">NAD+ 250mg</a></li>
        <li><a href="https://www.ivhub.com/iv-therapy/drips/nad-plus-500mg" target="_blank">NAD+ 500mg</a></li>
        </ul>
