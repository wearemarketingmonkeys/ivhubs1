...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    <head>
      ...
      <style>
        ...
        .email-container { background-color: #ffffff; padding: 30px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1); max-width: 600px; margin: auto; }
        h2 { color: #0d6efd; }
    ...
    <body>
      <div class="email-container">
        ...
        <table>
          ...
          <tr><th>Message</th><td>' . nl2br(htmlspecialchars($messageContent)) . '</td></tr>
        </table>
        <div class="footer">You received this email from IV Hub Contact Form.</div>
      </div>
    </body>
    </html>';
